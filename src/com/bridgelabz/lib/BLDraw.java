...
public final class BLDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static BLDraw std = new BLDraw();
    ...
    ***************************************************************************/
     ...
     * {@code BLDraw.BLACK}, {@code BLDraw.BLUE}, {@code BLDraw.CYAN},
     * {@code BLDraw.DARK_GRAY}, {@code BLDraw.GRAY}, {@code BLDraw.GREEN},
     * {@code BLDraw.LIGHT_GRAY}, {@code BLDraw.MAGENTA}, {@code BLDraw.ORANGE},
     * {@code BLDraw.PINK}, {@code BLDraw.RED}, {@code BLDraw.WHITE}, and
     * {@code BLDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to BLDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = BLDraw.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
...
*/
    ...
    ***************************************************************************/
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(BLDraw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            BLDraw.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    ***************************************************************************/
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = BLDraw.userX(e.getX());
            mouseY = BLDraw.userY(e.getY());
            isMousePressed = true;
        }
    }
    ...
    ***************************************************************************/
    ...
    public static void main(String[] args) {
        BLDraw.square(0.2, 0.8, 0.1);
        BLDraw.filledSquare(0.8, 0.8, 0.2);
        BLDraw.circle(0.8, 0.2, 0.2);

        BLDraw.setPenColor(BLDraw.BOOK_RED);
        BLDraw.setPenRadius(0.02);
        BLDraw.arc(0.8, 0.2, 0.1, 200, 45);

        // draw a blue diamond
        BLDraw.setPenRadius();
        BLDraw.setPenColor(BLDraw.BOOK_BLUE);
        double[] x = { 0.1, 0.2, 0.3, 0.2 };
        double[] y = { 0.2, 0.3, 0.2, 0.1 };
        BLDraw.filledPolygon(x, y);

        // text
        BLDraw.setPenColor(BLDraw.BLACK);
        BLDraw.text(0.2, 0.5, "black text");
        BLDraw.setPenColor(BLDraw.WHITE);
        BLDraw.text(0.8, 0.8, "white text");
    }
